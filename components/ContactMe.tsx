      ...
      max-w-7xl px-10 justify-evenly mx-auto items-center'>
          ...
          <div className='flex flex-col w-screen space-y-7'>
              ...
              <form className='flex flex-col space-y-2 mx-8' onSubmit={handleSubmit}>
                  ...
                  <button type="submit" disabled={state.submitting} className='bg-darkGreen/40 py-5 px-10 rounded-md text-black font-bold text-lg'>Submit</button>
              </form>

              {state.succeeded &&
              
              <div className='w-3/4 mx-auto px-6 py-2 bg-darkGreen/60 border border-[#E49B0F]/40 rounded-full text-md text-center text-black font-medium'>
                  <span>
