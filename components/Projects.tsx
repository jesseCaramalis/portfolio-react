                ...
                {projects.map((project) => (
                    ...
                    <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                        ...
                        <p className='text-lg text-center md:text-left'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum placeat optio at? Omnis maxime dicta ipsam repellendus voluptatibus quasi neque perferendis, consequuntur dolore maiores, qui illum molestias dolorem fuga molestiae.
                        </p>
                    </div>
                    </div>
                ))}
