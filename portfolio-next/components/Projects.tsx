...
export default function Projects({ projects }: Props) {
  return (
        ...
        >
          ...
          <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-darkGreen/80">
